...
const ManagerProduct = () => {
  ...
  const handleSubmit = () => {
    ...
    if (isUpdate) {
      ...
      axios
        .put("https://node-server-98j2.onrender.com/api/products/"+object.IDProduct, object)
        .then((response) => {
      ...
      axios
        .post("https://node-server-98j2.onrender.com/api/products",object)
        .then((response) => {
  ...
  useEffect(() => {
    axios
      .get(
        "https://node-server-98j2.onrender.com/api/products?search="+search
      )
      .then((response) => {
  ...
  const deleteObject = (data) => {
    axios
      .delete("https://node-server-98j2.onrender.com/api/products/" + data.IDProduct)
      .then((response) => {
